...
int main(int argc, char* argv[])
{
    try {
        ...
        ("behavior,b", po::value<std::string>()->default_value("../etc/ur3_collisions_behavior.yaml"), "Configuration file of the tasks (yaml) [default: ../etc/ur3_collisions_behavior.yaml]")
        ...
        ("controller,c", po::value<std::string>()->default_value("../etc/ur3_collisions_controller.yaml"), "Configuration file of the tasks (yaml) [default: ../etc/ur3_collisions_controller.yaml]")
